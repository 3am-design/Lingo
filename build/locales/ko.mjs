...
export default {
  ...
  home: {
    hero: {
      ...
      micro: '추가 1개 언어 무료 <span>/</span> WPML 불필요'
    },
    ...
    pricing: {
      kicker: '요금제',
      title: '작게 시작해서, 어디까지나',
      intro: '모든 요금제의 중심은 같습니다. 당신의 작업에 맞는 규모를 고르세요.',
      popular: '가장 인기',
      perYear: '/ 년',
      plans: [
        {
          ...
          price: '₩0',
          summary: '추가 언어 1개',
          points: ['모든 핵심 번역 기능', '깔끔한 URL + hreflang', '이전 미리보기와 되돌리기'],
          cta: '무료 버전 받기'
        },
        {
          name: 'Business',
          ...
          points: ['<strong>Free의 모든 기능</strong>', '명령 한 줄로 이전', 'WooCommerce 번역', '우선 지원과 업데이트'],
          cta: 'Business 구매'
        },
        {
          name: 'Agency',
          ...
          points: ['<strong>Business의 모든 기능</strong>', '사이트 활성화 무제한', '클라이언트 인수인계를 고려한 설계'],
          cta: 'Agency 구매'
        }
      ],
      trust: ['7일 환불 보장', '데이터는 당신의 것', 'WPML 불필요'],
      cta: {
        kicker: '아직 고민 중이신가요?',
        title: '한 가지 언어로 먼저.<br />당신의 사이트에서 결정하세요.',
        copy: '무료 버전은 추가 1개 언어를 지원합니다. 페이지 하나만 번역해서 <em>/fr/</em>가 공개되는 걸 확인한 뒤에 결정하세요. 먼저 물어볼 것이 있다면 <a href="mailto:hello@lingo.com">hello@lingo.com</a>으로 보내주세요.',
        primary: 'FAQ 읽어보기',
        secondary: '문서'
      }
    }
    ...
    groups: [
      {
        ...
        items: [
          ...
          { q: '몇 개 언어까지 운영할 수 있나요?', a: ['무료 버전은 추가 1개 언어까지이며, 그 뒤에는 완전한 번역 엔진이 있습니다. 기능을 덜어내지 않았습니다. 유료 요금제에서는 언어 수 제한이 사라집니다.'] }
        ]
      },
      {
        id: 'migration',
      ...
      },
      {
        ...
        items: [
          { q: '무료 버전에는 무엇이 포함되나요?', a: ['추가 1개 언어와 완전한 코어 일습입니다. 필드 단위 번역, 깔끔한 URL, 자동 hreflang, 전환기, 그리고 되돌리기가 포함된 이전 미리보기. 데모가 아니라 정직한 입구입니다.'] },
          { q: '유료 요금제에서는 무엇이 더해지나요?', a: ['언어 수 무제한, 명령 한 줄로 하는 이전(미리보기만이 아니라 실제 적용까지), WooCommerce 상품 번역, 그리고 자동 업데이트가 딸린 우선 지원입니다.'] },
          { q: '클라이언트 사이트에는 어떤 요금제가 필요한가요?', a: ['Business는 연 ₩179,000에 5개 사이트까지입니다. Agency는 연 ₩279,000에 사이트 활성화가 무제한 — 다국어가 클라이언트에게 넘기는 결과물의 일상적인 일부라면 고를 것은 Agency입니다.'] },
          { q: '환불받을 수 있나요?', a: ['네. 유료 요금제에는 7일 환불 보장이 있습니다. 그리고 결정하기 전에 무료 버전을 원하는 만큼 오래 쓰셔도 됩니다.'] },
